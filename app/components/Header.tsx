      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="container mx-auto px-4 py-4 flex flex-col gap-4">
            ...
            <a href="#servicios" className="text-gray-700 hover:text-blue-600">Services</a>
            <a href="#espacios" className="text-gray-700 hover:text-blue-600">Spaces</a>
            <a href="#reservar" className="text-gray-700 hover:text-blue-600">Book</a>
