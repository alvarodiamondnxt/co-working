    ...
    <section id="inicio" className="container mx-auto px-4 py-20 md:py-32">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">{t("hero.access24")}</h3>
          <p className="text-gray-600">{t("hero.access24Desc")}</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">{t("hero.wifi")}</h3>
          <p className="text-gray-600">{t("hero.wifiDesc")}</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">{t("hero.community")}</h3>
          <p className="text-gray-600">{t("hero.communityDesc")}</p>
        </div>
      </div>
    </section>
  );
